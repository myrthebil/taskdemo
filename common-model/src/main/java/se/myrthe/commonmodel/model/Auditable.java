...
/**
 * A base class for auditable entities that provides common auditing fields and functionality. This
 * class is meant to be extended by entity classes requiring audit information.
 *
 ...
 * {@link jakarta.persistence.MappedSuperclass} annotation allows entities inheriting this class to
 * embed these fields directly in their database tables.</p>
 *
...
public abstract class Auditable<T> {
  ...
  /**
   * Updates the timestamps and sets the user responsible before the entity is persisted. Typically
   * invoked by the persistence lifecycle events.
   */
  @PrePersist
  ...
  /**
   * Updates the {@code lastModifiedAt} timestamp and sets the user responsible before the entity is
   * updated.
   */
  @PreUpdate
